      ...
      <div className="mx-auto w-full max-w-7xl px-6 md:px-8 lg:px-10">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          {operationsSkills.map((skill) => (
            <span key={skill} className="rounded-full border border-border bg-muted px-4 py-2 text-sm font-medium transition-colors hover:bg-primary hover:text-primary-foreground">
              {skill}
            </span>
          ))}
        </div>
